...
!(function(t, e) {
            ...
            update: function(t, e, n) {
                if (t) {
                    var i = t.options.layout || {},
                        ...
                        h = re({ maxPadding: re({}, a), w: r, h: o, x: a.left, y: a.top },
                            a
                        );
                    !(function(t, e) {
                        var n, i, a;
            ...
            resize: function(t) {
                ...
                if (
                    ...
                    ((i.width = e.width = r),
                        ...
                        (i.style.width = r + "px"),
                        (i.style.height = o + "px"),
                        V.retinaScale(e, n.devicePixelRatio), !t)
                ) {
    ...
    function hn(t, e, n, i) {
        ...
        return (
            ...
            (m = x.indexOf(Math.max.apply(null, x))), { first: _(0), last: _(v - 1), widest: _(p), highest: _(m) }
        );
    }
                ...
                var t = this,
                    ...
                    a = (t.ticks = (function(t, e) {
                        ...
                        (r = Math.ceil(g / p) - Math.floor(f / p)) > u &&
                            ...
                            (a = Math.ceil(g / p) * p),
                            s &&
                            (!Mn(d) && V.almostWhole(d / p, p / 1e3) && (i = d), !Mn(h) && V.almostWhole(h / p, p / 1e3) && (a = h)),
                            (r = (a - i) / p),
                        ...
                        return (
                            ...
                            ((r = ri(t, "time", e[0], "pos")),
                                ...
                                (l =
                                    1 === e.length ?
                                    o :
                                    (o - ri(t, "time", e[e.length - 2], "pos")) / 2)), { start: s, end: l, factor: 1 / (s + 1 + l) }
                        );
                    })(i._table, d, 0, 0, o)),
                    s.reverse && d.reverse(),
                    ui(i, d, i._majorUnit)
